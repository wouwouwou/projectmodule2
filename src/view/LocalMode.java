...
public class LocalMode extends Thread {
    ...
    private String[] getPlayers() {
    	...
    	String human = StandardInput.readChoice("> Do you want to play against an AI or against another human player? (ai/human)?", "ai", "human");
    	if (human.equals("human")) {
    		args[0] = StandardInput.getString("> Player 1, what is your name?");
    		args[1] = StandardInput.getString("> Player 2, what is your name?");
    	}
    	else {
    		args[0] = StandardInput.getString("> What is your name?");
    		args[1] = "-N";
    	}
    	return args;
    }
